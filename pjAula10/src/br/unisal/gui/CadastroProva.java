...
import br.unisal.modelagem.AlterarProduto;
...
public void alterar() {
		...
		boolean alterar = AlterarProduto.alterar(produtos, codigo, descricao);
		JOptionPane.showMessageDialog(null, alterar ? "Informações alteradas." : "Erro");
	}
