...
public class frmCliente extends JFrame implements ActionListener{
	...
	public frmCliente() {
		...
		btCadastrar.setToolTipText("Cadastrar um cliente");
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource() == btCadastrar) {
			try {
				...
				JOptionPane.showMessageDialog(null, "Erro na manipulação do Arquivo Texto."
						+ erro, "Erro no arquivo Texto", JOptionPane.ERROR_MESSAGE);
			}
		}
